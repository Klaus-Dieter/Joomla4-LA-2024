...
class pkg_ImportexportusersInstallerScript
{
    ...
    protected function showInstallMessage($messages = array())
    {
        ...
        <p>Our plugin is compatible with Joomla 3 & 4 both.</p>
        ...
        <div class="mo-row">
            <a class="mo_boot_btn mo_boot_btn-users_sync" onClick="window.location.reload();"
               href="index.php?option=com_miniorange_importexportusers&view=accountsetup&tab-panel=account">Start Using miniOrange Import Export Users plugin</a>
