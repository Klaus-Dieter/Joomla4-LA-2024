...
class SppagebuilderAddonClients extends SppagebuilderAddons
{
	...
	public function render()
	{
		...
		$carousel_item_number = $settings->carousel_item_number ?? null;

		$carousel_item_number_xl = !empty($carousel_item_number) && !empty($carousel_item_number->xl) ? $carousel_item_number->xl : 5;
		$carousel_item_number_lg = !empty($carousel_item_number) && !empty($carousel_item_number->lg) ? $carousel_item_number->lg : 4;
		$carousel_item_number_md = !empty($carousel_item_number) && !empty($carousel_item_number->md) ? $carousel_item_number->md : 3;
		$carousel_item_number_sm = !empty($carousel_item_number) && !empty($carousel_item_number->sm) ? $carousel_item_number->sm : 3;
		$carousel_item_number_xs = !empty($carousel_item_number) && !empty($carousel_item_number->xs) ? $carousel_item_number->xs : 2;
	...
	public static function getTemplate()
	{
        ...
        if(_.isObject(data.carousel_item_number)){
			...
			carousel_item_number_xl = xl ?? 5;
			carousel_item_number_lg = lg ?? 4;
            carousel_item_number_md = md ?? 3;
            carousel_item_number_sm = sm ?? 3;
            carousel_item_number_xs = xs ?? 2;
		}
