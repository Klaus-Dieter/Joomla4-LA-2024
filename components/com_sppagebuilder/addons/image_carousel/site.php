...
class SppagebuilderAddonImage_carousel extends SppagebuilderAddons
{
    ...
    public function render()
    {
        ...
        $carousel_center_padding_xl = (isset($settings->carousel_center_padding_xl) && $settings->carousel_center_padding_xl) ? $settings->carousel_center_padding_xl : 180;
        $carousel_center_padding_lg = (isset($settings->carousel_center_padding_lg) && $settings->carousel_center_padding_lg) ? $settings->carousel_center_padding_lg : 180;
        $carousel_center_padding_md = (isset($settings->carousel_center_padding_md) && $settings->carousel_center_padding_md) ? $settings->carousel_center_padding_md : 180;
