 ...
 * 
 * @since 4.0.0
 * @TODO: Will be removed after shifting the remaining methods to the backend.
 */
class SppagebuilderControllerDashboard extends AdminController
{
    ...
    public function loadPages()
    {
        ...
        try
        {
            ...
            $query->select('p.id, p.title, p.extension_view, p.catid, p.published, p.created_on, p.created_by, p.language, p.hits, p.checked_out, p.css');
