...
class plgSystemMediabox_ck extends JPlugin {
	...
	function onBeforeRender() {
		...
		// get the language
		$this->loadLanguage();
		JText::script('MEDIABOXCK_SHARE');
		JText::script('MEDIABOXCK_EMAIL');
	...
	#mbTitle, #mbPrevLink, #mbNextLink, #mbCloseLink, #mbPlayLink, #mbPauseLink, #mbZoomMinus, #mbZoomValue, #mbZoomPlus {
		...
		$document->addScript(JURI::base(true)."/plugins/system/mediabox_ck/assets/mediaboxck.min.js?ver=2.6.0");
		...
		$document->addScriptDeclaration("
						Mediabox.scanPage = function() {
							...
							new Mediaboxck(links, {
								...
								counterText: '" . JText::_('MEDIABOXCK_COUNTER_TEXT') . "',
