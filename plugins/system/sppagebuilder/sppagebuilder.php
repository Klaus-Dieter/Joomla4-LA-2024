...
class  plgSystemSppagebuilder extends CMSPlugin
{
	...
	function onAfterRender()
	{
		...
		if ($app->isClient('administrator'))
		{
			...
			{
				$dashboardHTML = '<a href="' . $backendEditorLink . '" target="_blank" class="sp-pagebuilder-button-outline">Edit with Backend Editor</a><a href="' . $frontendEditorLink . '" target="_blank" class="sp-pagebuilder-button">Edit with Frontend Editor</a>';
			}
